...
$random=rand(1,10000);
  $urll = "http://www.mypage.com/index.php?rnd=";
  $url= $urll.$random;
   
$id=uniqid();
$q3=mysqli_query($con,"INSERT INTO quiz VALUES  ('$id','$name' , '$sahi' , '$wrong','$total','$time' ,'$desc','$tag',NOW(),'$url')");
//$q3=mysqli_query($con,"INSERT INTO `quiz`(`eid`,`name`,`sahi`,`wrong`,`time`,`tag`,`desc`,`date`,`url`) VALUES  ('$id','$name' , '$sahi' , '$wrong','$total','$time' ,'$desc','$tag', NOW()),'$url");
echo '$url';
