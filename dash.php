...
if(@$_GET['q']==4 && (@$_GET['step'])==2 ) {
     ...
     //$url=randomURL();
     $random=rand(1,10000);
     $url = "http://www.mypage.com/index.php?rnd=";
    // echo 'alert("hello")';
     $urll= '<tr><td>'.$url.'</td></tr>'.$random;
     //echo $urll;
...
echo '<div class="form-group">
  <label class="col-md-12 control-label" for=""></label>
  <div class="col-md-12"> 
    <input  type="submit" style="margin-left:45%" class="btn btn-primary" name="insert" value="Submit" class="btn btn-primary"/>
  </div>
</div>
...
while($row = mysqli_fetch_array($result)) {
	...
	$eid = $row['eid'];
	echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
	<td><b><a href="update.php?q=rmquiz&eid='.$eid.'" class="pull-sahi btn sub1" style="margin:0px;background:red"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span></a></b></td></tr>';
}
$c=0;
echo '</table></div></div>';
